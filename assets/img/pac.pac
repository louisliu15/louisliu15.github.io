...
function _check_regex_list(i, o) {
    ...
    for (var c = 0; c < i.length; c++) if (i[c].test(o)) return ! 0;
    return ! 1
}
...
var _http_map = {
    ...
    proxy: {
        any: [/^[^\/]*\.cupid\.iqiyi\.com\//i, /^[^\/]*\.video\.qq\.com\//i, /^[^\/]*\.video\.qq\.com\//i, /^[^\/]*\.dpool\.sina\.com\.cn\//i, /^[^\/]*\.letv\.com\//i, /^[^\/]*\.api\.tv\.itc\.cn\//i, /^[^\/]*\.letv\.cn\//i, /^[^\/]*\.ssports\.com\//i],
        "acs.youku.com": [/^\//i],
        "pl-ali.youku.com": [/^\//i],
